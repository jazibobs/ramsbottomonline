  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row gap-8 max-w-screen-xl mx-auto my-16 p-8 lg:p-2">
      <div className="w-full lg:w-1/4 bg-white shadow-xl rounded-lg overflow-hidden relative">
        ...
        <div className="prose prose-slate font-sans px-4 pt-4 pb-48 text-sm">
    ...
    <div className="prose prose-slate text-center mx-auto my-16 p-4">
      <h2>Need something a bit special?</h2>
      <p className="font-sans mb-8">If you are looking for support with something a bit more specialist, get in touch to discuss custom web application, mobile application, plugin or web service.</p>
    </div>
    <ServiceCta />
  </>
  );
